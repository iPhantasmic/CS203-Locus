                    ...
                    <div className="content bg-white ">
                        <div className="flex-col flex items-center p-8" >
                            <div className="flex-row flex justify-center text-center" >
                                <QRCode value={Buffer.from("dDs68X26aUASiuxz184t&E").toString('base64')} size={100} fgColor={props.isVaccinated ? "#0c724a" : "#a4091c"}/>
                                {/*<img src="/qr-code.png"  />*/}
                            </div>
                            <div className="flex-row flex mt-5" >
                                <div className = "flex-col flex justify-center text-center">
                                    ...
                                    <span>{Buffer.from("dDs68X26aUASiuxz184t&E").toString('base64')}</span>
                                </div>
                            </div>
