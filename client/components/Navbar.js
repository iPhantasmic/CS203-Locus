...
export default function Navbar(props) {
    ...
    return (
        <div className="h-20 w-full px-7 flex flex-row items-center justify-between">
            ...
            <div>
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-gray-800 hover:text-green-500" fill="none" viewBox="0 0 24 24" >
