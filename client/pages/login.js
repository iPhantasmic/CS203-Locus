    ...
    return (
        <div className = "h-screen w-screen flex-col flex items-center justify-center">
            ...
            <div className = "flex-col flex border p-5 bg-white rounded-xl shadow-xl">
                ...
                <input placeholder = "Username/Email Address" className = "rounded border mb-4 h-14 px-3 w-96 rounded" style = {{fontSize:13}}/>
                <input placeholder = "Password" className = "rounded border mb-4 h-14 px-3"/>
                <button onClick = {()=>{console.log("Hello")}} className = "self-start mb-8 rounded" style = {{color:"#32BEA6"}}>
                    Forgot password?
                </button>
                <div className = "w-full items-center flex flex-col justify-center h-14 rounded-full" style = {{backgroundColor:"#32BEA6" , color:'white'}}>
