    ...
    return (
        <div>
            ...
            <div className="px-16 flex-col flex">
                ...
                <Divider />
                <div className = "mb-5">
                    <span style={{ fontSize: 30 }} >Upcoming Public Events</span>
                </div>

                {/* TODO: Refactor this events part */}
                <div className="flex-row flex p-5 items-center w-full shadow-lg mb-5 rounded-md" style = {{height:180}}>
                    <div>
                        <Image
                            src="/event1.jpeg"
                            height={130}
                    ...
                    <div className=" flex-col flex h-full ml-5 w-1/2 justify-between p-1">
                        <span style = {{color:"#32BEA6" ,fontSize:16}}>Fri, 17th Sep 2021, 1:00 PM</span>
                        <span className = "font-bold" style = {{fontSize:18}}>3D Augmented Chalk Exhibit</span>
                        <span>Professional 3D Street Art Murals in chalk and paint and 4D Immersive Installations using Augmented and Virtual Reality</span>
                    </div>
                </div>
                <div className="flex-row flex p-5 items-center w-full shadow-lg mb-5 rounded-md" style = {{height:180}}>
                    <div>
